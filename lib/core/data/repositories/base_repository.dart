...
import 'package:interesting_places/api/data/error_response_dto.dart';
import 'package:interesting_places/core/domain/entities/failure/failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/bad_request_failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/internal_server_failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/network_failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/no_network_failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/server_not_responding_failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/too_many_requests_failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/unauthorized_failure.dart';
import 'package:interesting_places/core/domain/entities/failure/network/unknown_network_failure.dart';
...
abstract base class BaseRepository {
  ...
  RequestOperation<T> makeApiCall<T>(AsyncValueGetter<T> call) async {
    ...
    try {
      ...
      failureResult = Result.failed(
        UnknownFailure(message: e.toString(), stackTrace: s),
        s,
      );
    }
